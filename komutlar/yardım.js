...
exports.run = (client, message, params) => {
  ...
  .setDescription('')
  .setColor(0x00ffff)
      .setDescription('**•** d!eğlence = Eğlence komutları\n**•** d!kişisel = Kişisel komutlar\n**•** d!yetkili = Yetkili komutları\n**•** d!oyun = Oyun komutları\n**•** d!müzik = Müzik komutları\n**•** d!destek = Destek komutları')
